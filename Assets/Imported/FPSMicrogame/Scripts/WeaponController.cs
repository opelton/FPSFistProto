...
public class WeaponController : MonoBehaviour {
    ...
    // Firing angle offset
    bool _useShotAngleOverload = false;
    Transform _shotAngleOverload;

    public void OverloadShotAngle(Transform shotAngleOverload) {
        _shotAngleOverload = shotAngleOverload;
        _useShotAngleOverload = true;
    }
    ...
    void HandleShoot() {
        ...
        for (int i = 0; i < bulletsPerShotFinal; i++) {
            // player aims at a lower angle than their camera view
            var weaponDirection = _useShotAngleOverload ? _shotAngleOverload : weaponMuzzle;
            Vector3 shotDirection = GetShotDirectionWithinSpread(weaponDirection);
